...
class HighscoresView extends AbstractView {
    ...
    private JPanel initHighScoreList(){
        Font defaultFont = Constants.DEFAULT_FONT.deriveFont(18F);
        ...
        try {
            ...
            listCollumHeaderBorder = BorderFactory.createEmptyBorder(trophyImage.getIconHeight()/2-defaultFont.getSize()/2,0,trophyImage.getIconHeight()/2-defaultFont.getSize()/2,0);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        collumName.setFont(defaultFont);
        ...
        collumScore.setFont(defaultFont);
        ...
        collumDate.setFont(defaultFont);
